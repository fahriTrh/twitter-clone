...
const PostFormSidebar = () => {
    ...
    const postOnSUbmit = (e) => {
        ...
        setText('')
        document.querySelector('#image-preview-side').style.display = 'none'
        setImage(null)
    }
    ...
    const previewImage = (e) => {
        const image = document.querySelector('#image_side')
        const imgPreview = document.querySelector('#image-preview-side')
    ...
    return (
        <div className="p-4 w-full flex items-start gap-1 h-auto">
            ...
            <div className="w-[87%] h-auto ml-2 bg-geen-500">
                <form onSubmit={postOnSUbmit} className="relative">
                    ...
                    {/*input image  */}
                    <img id="image-preview-side" src="" style={{ display: 'none' }} className="w-full h-[320px] rounded-lg object-cover object-center" />
                    <input id="image_side" name="image" className="w-0 h-0" type="file" onChange={previewImage} />
